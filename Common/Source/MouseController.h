...
class CMouseController: public SingletonTemplate<CMouseController>
{
	friend SingletonTemplate<CMouseController>;

public:
	static class CMouseController* GetInstance(void);
...
protected:
	...
	static CMouseController* m_instance;
