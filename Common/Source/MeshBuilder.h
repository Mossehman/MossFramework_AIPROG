...
public:
	...
	static Mesh* GenerateAnimatedQuad(const std::string& meshName, glm::ivec2 CurrentAnimationPos, glm::vec2 SpriteSize);
	...
	static Mesh* GenerateLineDir(const std::string& meshName, Color color, glm::vec2 startPos, glm::vec2 endPos);
